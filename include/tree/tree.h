 ...
 *
 * @iallocator    - a pointer to an allocator interface that implements
 ...
 * @buffer        - pointer to the section that the tree will use for
 *                  initialization
 */
tree_t*
...
/*
 * function @tree_sizeof returns the size in bytes that is needed to allocate
 * the necessary memory block to initialize the tree on it
 */
int
tree_sizeof();
